...
public class CountryAdapter3 extends BaseAdapter {
    ...
    public CountryAdapter3(Context context, List<Country> countries, int layoutItem) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.countryflag = (ImageView) convertView.findViewById(R.id.flag);
        ...
        viewHolder.countryflag.setImageResource(countries.get(position).getFlagID());
